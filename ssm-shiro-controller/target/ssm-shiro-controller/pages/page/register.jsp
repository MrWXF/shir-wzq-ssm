...
<div class="register-box">
    ...
    <div class="register-box-body">
        ...
        <div class="social-auth-links text-center ">
            ...
            <span class=" btn-block btn-google" ><i id="nopower">${noEmpty}</i></span>

        </div>

        <form action="${pageContext.request.contextPath}/admin/register.do" method="get">
        ...
        <a href="${pageContext.request.contextPath}/pages/page/login.jsp" class="text-center">我有账号，现在就去登录</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
